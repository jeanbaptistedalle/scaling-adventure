...
\begin{itemize}
 \item[Dessiner:] On dessine une forme en s\'electionnant le type de la forme (rectangle, cercle, \ldots) gr\^ace au des boutons d\'edi\'es. Ensuite, on r\'ealise un "drag\&drop" ("glisser-d\'eposer" en fran\c{c}ais) sur la zone de dessin.
