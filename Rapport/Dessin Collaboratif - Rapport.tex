...
\begin{itemize}
	...
	\item[3]A peut donc prendre la main. Il dessine quelques formes. Après chaque modification, l'image est répercutée sur B.
	\item[4]B demande la main.
	\item[5]Lorsque A perd la main (à la fin d'un timer défini), B récupère la main et peut maintenant dessiner.
...
\begin{itemize}
	\item[1]Le « propriétaire » lance le serveur
	\item[2]Deux utilisateur A et B se connectent sur le serveur.
	\item[3]A dessine quelques formes. Après chaque modification, l'image est répercutée sur B.
	\item[4]A perd sa connexion internet.
	\item[5]La main passe automatiquement à B si il l'avait demandé qui est alors le seul utilisateur encore présent dans ce salon.
...
\begin{center}
\includegraphics[scale=0.5]{image/server.jpg}
\end{center}
...
\begin{center}
\includegraphics[scale=0.5]{image/architecture.jpg}
\end{center}
